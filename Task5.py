...
class App(tk.Tk):
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = tk.Label(self, text='Welcome to Real Time Currency Converter', fg='blue', relief=tk.RAISED,
                                    borderwidth=3)
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = tk.Label(self,
                                   text=f"1 USD = {self.currency_converter.convert(1, 'USD', 'EUR')} EUR \n Date : {self.currency_converter.data['date']}",
        ...
        self.amount_field = tk.Entry(self, bd=3, relief=tk.RIDGE, justify=tk.CENTER, validate='key',
                                     validatecommand=valid)
        self.converted_amount_field_label = tk.Label(self, text='', fg='black', bg='white', relief=tk.RIDGE,
    ...
    def perform(self):
        ...
        converted_amount = self.currency_converter.convert(amount, from_curr, to_curr)
